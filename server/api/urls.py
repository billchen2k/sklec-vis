...
urlpatterns = [
    ...
    # path('tags/create/', views.DatasetTagCreate.as_view()),
    # path('tags/destroy/<str:uuid>/', views.DatasetTagDestroy.as_view()),
    # path('tags/update/<str:uuid>/', views.DatasetTagPatch.as_view()),
