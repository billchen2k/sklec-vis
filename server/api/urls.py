...
urlpatterns = [
    ...
    path('formdata/fieldmeta/<str:uuid>/',
         ...
         name='FormDataFieldType'),
    path('formdata/fieldmetabatch/', views.PostFormDataFieldMetaBatch.as_view(), name='BatchFormDataFieldMeta'),
    ...
    path('formdata/table/<str:uuid>/',
         ...
         name='FormDataTable'),
    path('formdata/cell/', views.FormDataCellViewSet.as_view({'get': 'list', 'post': 'create'}),
         name='Cell'),
    path('formdata/cell/<str:uuid>/',
         views.FormDataCellViewSet.as_view({'get': 'retrieve', 'patch': 'partial_update', 'delete': 'destroy'}),
         name='Cell'),
    path('formdata/tablecsv/<str:uuid>/', views.GetFormDataTableCSV.as_view()),
    path('formdata/tablecsv/', views.PostFormDataTableCSV.as_view()),
