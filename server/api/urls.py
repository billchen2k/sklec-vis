...
urlpatterns = [
    ...
    path('formdata/tabletype', views.FormDataTableTypeViewSet.as_view({'get': 'list', 'post': 'create'}),
         name='FormDataTableType'),
    path('formdata/tabletype/<str:uuid>',
         views.FormDataTableTypeViewSet.as_view({'get': 'retrieve', 'patch': 'partial_update', 'delete': 'destroy'}),
         name='FormDataTableType'),
    path('formdata/fieldtype', views.FormDataFieldTypeViewSet.as_view({'get': 'list', 'post': 'create'}),
         name='FormDataFieldType'),
    path('formdata/fieldtype/<str:uuid>',
         views.FormDataFieldTypeViewSet.as_view({'get': 'retrieve', 'patch': 'partial_update', 'delete': 'destroy'}),
         name='FormDataFieldType'),
